...
if (pkg.version !== "3.2.2") failures.push("package.json n'est pas en version 3.2.2");
...
if (failures.length) {
  console.error("KizConnect V3.2.2 — échec du contrôle statique:\n- " + failures.join("\n- "));
  process.exit(1);
}

console.log("KizConnect V3.2.2 — contrôle statique OK.");
