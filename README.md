...
- pour une bêta, la confirmation email peut rester activée ;
...
## Ce qui n'est volontairement pas dans la V3
...
La V3 reste une bêta : avant publication publique, les tests multi-comptes du plan de test doivent être réalisés sur le vrai projet Supabase.
